    ...
    <tbody>
        ...
        foreach ($comments as $comment): ?>
            <tr id="comment<?= $comment->getId(); ?>">
                ...
                <td>
                  <a href="/PHP/project/www/comments/<?= $comment->getId(); ?>/edit">Редактировать</a>
                  <br>
                  <a href="/PHP/project/www/comments/<?= $comment->getId(); ?>/delete" onclick="return confirm('Удалить комментарий?');">Удалить</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
